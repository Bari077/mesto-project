...
export {popup, editBtn, formProfile, modalProfile, addCardBtn, modalAddCard, closeBtn, formAddCard, inputName, inputJob, profileName, profileJob, initialCards, cardsContainer}